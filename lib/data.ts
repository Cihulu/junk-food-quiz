...
export const FOODS: Food[] = [
  {
    ...
    description: "不是所有人都懂你的好，而你也不需要所有人懂。你就这样酥酥脆脆地保持自我，等着某一天某一个人突然长大了悟到了你的美味。你是被时间筛选过的垃圾食品，虽然吃完一地碎屑也不好清理。\n桃酥最好是配茶？配咖啡？还是什么都不用配 做自己最好了。\n依稀记得某溪河还是某记桃酥有创新口味来着，但似乎只有原味纯粹的你最有记忆点。",
    portion: "3块 ≈ 150g", kcal: 721, calorieCompare: "≈ 45根黄瓜\n（全部吃完要4小时）",
  },
  {
    id: "crayfish", name: "小龙虾", emoji: "🦞", vector: [0, 0, 0, 2],
    description: "你是夏天限定版的美味。你的出现就是传说。人类念起你的名字就会自动分泌唾液。不当季的时候也会时常被记挂，只要到了那个季节，那个夜晚，那群人，根本停不下来。壳厚肉甜，费劲但值得。\n最近好像有啥新东西一直在蹭你的热度，呃是啥来着？不重要，你自有你的鲜香麻辣/蒜香油润。",
    portion: "一份带壳 ≈ 500g，净肉约200g", kcal: 230, calorieCompare: "≈ 3个水煮蛋\n（剥壳消耗的热量已经快抵消了）",
  },
  {
    id: "salad", name: "多酱版鸡胸肉沙拉", emoji: "🥗", vector: [0, 0, 2, 0],
    description: `你是垃圾食品里的异类。表面健康自律，满满都是蛋白质和纤维素。但选择"多放沙拉酱"也是人之常情吧、、你不主动宣传自己有多垃圾，但你从来没骗过任何人。只是有些真相，不说而已。\n号称身材管理的人将你视若珍宝，但你只默默地当带刺玫瑰。"有本事不加酱，小心得厌食症。"你如是说。`,
    portion: "一份加酱 ≈ 350g", kcal: 420, calorieCompare: "≈ 8个西红柿\n（但沙拉酱独自贡献了200kcal）",
  },
  {
    id: "noodles", name: "泡面", emoji: "🍜", vector: [0, 0, 2, 2],
    description: `深夜十二点，开水倒进去，整个房间充斥着迷人危险气息。室友会忍不住问"能给我来一口吗"。其实你不耀眼，包装也没有什么说头，但那一刻谁都知道你是正确答案。其实也有很多人莫名其妙隔一段时间就想到你。\n毕竟不需要洗餐具。但你总是叮嘱人类请记得把吃剩的面汤倒厕所后再丢弃。`,
    portion: "一包含料包 ≈ 100g", kcal: 460, calorieCompare: "≈ 28根黄瓜\n（深夜的满足感，黄瓜给不了）",
  },
  {
    id: "milktea", name: "奶茶", emoji: "🧋", vector: [0, 2, 0, 0],
    description: "你是情绪的换算单位。一杯奶茶等于「今天辛苦了」，等于「我们好久没见了」，等于某个秋天下午被需要的感觉。小料有好多好多种，但是如果今天某个小料卖完了，人也不会失望地转头就走，因为只要是你就可以。\n大家喜欢你，你也知道大家喜欢你。但是你的底线是：不背刺爱你的人。这一点，你的很多竞品都没有做到。",
    portion: "一杯全糖含珍珠 ≈ 500ml", kcal: 430, calorieCompare: "≈ 8个苹果\n（今天辛苦了 = 8个苹果的热量）",
  },
  {
    id: "fries", name: "薯条", emoji: "🍟", vector: [0, 2, 0, 2],
    description: "刚出锅的时候是绝对的神。人会花一小时争论哪家做的薯条最好吃，争论无果后逐一买来做测评。还有人闭着眼睛都能吃出你是哪家的出品。\n有人爱蘸番茄酱，有人不要酱，但是几乎没人不爱你吧。你以对的温度和咸味出现，所有人都说美味啊绝顶美味。\n凉了不行。",
    portion: "中份 ≈ 120g", kcal: 374, calorieCompare: "≈ 23根黄瓜\n（全部吃完之前，脑子没来得及数）",
  },
  {
    id: "paineapple", name: "菠萝油", emoji: "🍞", vector: [0, 2, 2, 0],
    description: "你不是稀有的，但完美状态的你很稀有。不是每家都做得好，做得好的那家也不是每次去都能赶上刚出炉。热热的菠萝包，冷藏的黄油，缺一不可。两个相悖的口感在嘴里融合升华。\n懂你的人会卡着时间去找你，吃完了觉得今天运气真不错。不懂的人随便买个尝尝，拿到一个凉透了的，觉得没什么特别。\n时机这件事，本来就不是所有人都有耐心等的。",
    portion: "一个 ≈ 130g", kcal: 455, calorieCompare: "≈ 6个水煮蛋\n（惊喜感是无价的，热量是有价的）",
  },
  {
    id: "icecream", name: "冰淇淋", emoji: "🍦", vector: [0, 2, 2, 2],
    description: "你存在于各种「不应该」里。肠胃不好不应该，生病不应该，减肥期间不应该，但你被需要的那一刻没有人真的在想这些。吃完心情好了，别的事情以后再考虑。\n你甜甜的又有各种形态，其实会被路过的小孩眼巴巴扒着玻璃围观。\n什么gelato什么欧洲冻酸奶什么椰子灰，人总想买来尝尝这玩意啥味儿，想着怎么也不会出错吧，但最后应该都要控诉一块冰碴子凭啥卖这么贵，还是老冰棍最好吃。",
    portion: "一球/一支 ≈ 100g", kcal: 200, calorieCompare: "≈ 4个苹果\n（今日份好心情 = 4个苹果的热量）",
  },
  {
    id: "luosifen", name: "螺蛳粉", emoji: "🍝", vector: [2, 0, 0, 0],
    description: "你永远不需要为自己辩护。有人一经过门口就皱眉，有人专程坐一个小时地铁来找你。你对这两种人的态度是一样的——爱吃就吃，不吃拉倒。\n味道比你先到人那里。有人叫它臭，有人叫它香，反正都是你，反正都记住了。你不解释，也不挽留。喜欢你的人不需要理由，而且一旦爱上，就很难回头。\n其实螺蛳粉里也可以没有螺蛳，但你的灵魂始终独树一帜。吃起来应该就是像美食博主测评的一样美妙吧。",
    portion: "一包煮好 ≈ 400g", kcal: 560, calorieCompare: "≈ 35根黄瓜\n（你的独特魅力，黄瓜永远学不会）",
  },
  {
    id: "soda", name: "汽水", emoji: "🥤", vector: [2, 0, 0, 2],
    description: "啵——那声开罐声就是你的出场BGM。你根本无需宣传代言。第一口最冲，气最足，有点想咳嗽但忍住了。\n有人说喝无糖的比较健康。好吧，0糖0脂0卡版的你依然让人上瘾，似乎还有研究表明那些甜味剂更不健康来着（你只是道听途说）。你从没骗过任何人，你只是没主动说清楚。\n据说有腐蚀性。嗯，也许吧。谁在乎呢，你好喝。",
    portion: "一罐 ≈ 330ml", kcal: 140, calorieCompare: "≈ 9根黄瓜\n（黄瓜能产生气泡吗？）",
  },
  {
    id: "sausage", name: "淀粉肠", emoji: "🌭", vector: [2, 0, 2, 0],
    description: "你的成分是一个谜，而且是那种查了也不想知道答案的谜。网上每隔一段时间就有人发帖考证你到底是什么做的，评论区吵成一片，然后大家该吃还是吃。\n三块钱一根，五块钱两根。路过就买，不需要理由，也不需要饿。咬下去，外面脆，里面烫，必定烫嘴，每次都烫，每次都没有吸取教训。\n你不宣传自己的内在。内在也确实神秘。但烤得金黄焦脆的外皮告诉所有人：来吃。",
    portion: "一根烤好 ≈ 80g", kcal: 192, calorieCompare: "≈ 2.5个水煮蛋\n（成分是谜，热量是实）",
  },
  {
    id: "latiao", name: "辣条", emoji: "🌶️", vector: [2, 0, 2, 2],
    description: "包装看着凶，颜色看着辣，但吃进嘴里是甜的。你也不是故意讨好小学生。\n喜欢你的人有一种共同的记忆——校门口小卖部，五毛钱，伸手就有。撕开的那一瞬，手上沾了红油，随便往哪一抹，开吃。\n有时候你在课堂上。本来打算悄悄吃，结果袋子一撕，全世界都知道了。老师还没说话，同桌已经伸手过来了。你就这样毫无预兆地成为全场焦点。",
    portion: "一包 ≈ 65g", kcal: 260, calorieCompare: "≈ 16根黄瓜\n（小孩能忽略的卡路里）",
  },
  {
    id: "chicken", name: "炸鸡", emoji: "🍗", vector: [2, 2, 0, 0],
    description: `韩剧里总有人在哭着吃炸鸡配啤酒。你不觉得夸张。有些情绪不需要被解决，只需要被喂饱。你不是那种需要找具体理由才能吃的垃圾食品啦，人类隔一段时间就会突然非你不可。\n你总那么坦荡，不为高热量道歉。不过偶尔品控不稳定或者吃出异物的时候会被喷"热量这么高还敢出错"罢了。`,
    portion: "两块鸡腿/翅 ≈ 200g", kcal: 540, calorieCompare: "≈ 7个水煮蛋\n（坦荡，高热量，不道歉）",
  },
  {
    ...
    portion: "一袋 ≈ 75g", kcal: 413, calorieCompare: "≈ 26根黄瓜\n（黄瓜味薯片也好吃）",
  },
  {
    id: "burger", name: "汉堡", emoji: "🍔", vector: [2, 2, 2, 0],
    description: "面包、生菜、肉饼、番茄，拆开来看朴实无华，你却是名副其实的垃圾食品代表。不过你出现在哪里都不违和。十几二十块的快餐店有你，人均300的精品burger馆也有你。\n你在哪都可以是主角正餐，吃完可能再也容不下别的食物了。\n垃圾食品里最体面的，体面食物里最垃圾的。你对此毫无愧疚。",
    portion: "一个普通款 ≈ 200g", kcal: 520, calorieCompare: "≈ 10个苹果\n（当正餐吃吧又没关系）",
  },
  {
    id: "cookie", name: "饼干", emoji: "🍪", vector: [2, 2, 2, 2],
    description: "所有人都觉得认识你，但没有人真的研究过你。\n童年回忆，春节必囤，国民零食，随便哪个词都能套上去。很少有人会专门发帖说你好吃。但也没有人说不喜欢你。茶几上，办公室零食篮里，酥酥脆脆，有甜有咸。手边总是有你，就顺嘴吃了很多。\n直到有一天翻开配料表——哦。酥酥脆脆，原来都是有代价的。原来你没欺骗过任何人。你只是从来不主动介绍自己。",
    portion: "半包夹心饼干 ≈ 80g", kcal: 390, calorieCompare: "≈ 5个水煮蛋\n（小饼干，大热量）",
  },
];
